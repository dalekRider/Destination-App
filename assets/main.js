// Foursquare API Info
const clientId = 'DHSF25UMAECQWZQTYNMFM0JFE1RQXXI4KEFGVC0BPITXFKT2';
const clientSecret = 'NBG0B1GHUYDA1LWHLOUUZXRUEGJ2AOUEQOHDM3GSIBP4WMMT';
const url = 'https://api.foursquare.com/v2/venues/explore?near=';
const imgPrefix = 'https://igx.4sqi.net/img/general/275x366';

// APIXU Info
const apiKey = '54de812a6470422f8db140440170210';
...
async function getVenues() {
  ...
  const urlToFetch = url + city + '&venuePhotos=1&limit=10&client_id=' + clientId +
   '&client_secret=' + clientSecret + '&v=20171002';
...
function renderVenues(venues) {
  $venueDivs.forEach(($venue, index) => {
    let venueContent =
      ...
      '<h3>Rating: ' + venues[index].rating + '</h3>' +
      '<p><a href="' + venues[index].url + '">Website</a></p>';
